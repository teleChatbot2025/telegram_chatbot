    ...
    try:
        ...
        if wait_for_server(MCP_SERVER_PORT, timeout=45):
            ...
            print(
                ...
                "   Possible reasons:\n"
                "   1. First startup needs to download models (sentence-transformers)\n"
                "   2. Server startup error\n"
                "\n"
                "   Suggestions:\n"
                f"   - Start MCP server manually to see logs: python {MCP_SERVER_SCRIPT}\n"
            ...
            if mcp_process:
                try:
                    ...
                    if stderr:
                        print(f"\n   Server error output:   {stderr[:500]}")
                except Exception:
                    pass
